...
def main():
    ...
    parser.add_argument('--net', dest='net', default='xvector', type=str, action='store', help='Network model architecture')
    ...
    parser.add_argument('--test_file', dest='test_file', default='/home/meddameloni/dl-fair-voice/exp/test/Voxceleb-test.csv',type=str, action='store', help='CSV file used for testing')
    ...
    parser.add_argument('--model_path', dest='model_path', default='/home/meddameloni/dl-fair-voice/exp/trained_model/xvector_18062020_2334_English-Spanish-train3/weights-15-0.993.h5', type=str, action='store', help='audio folder path')
    # parser.add_argument('--model_path', dest='model_path', default='/home/meddameloni/dl-fair-voice/exp/trained_model/xvector_14062020_1227_English-Spanish-train1/weights-11-0.982.h5', type=str, action='store', help='audio folder path')
    # parser.add_argument('--model_path', dest='model_path', default='/home/meddameloni/dl-fair-voice/exp/trained_model/xvector_14062020_1227_English-Spanish-train1/weights-13-0.992.h5', type=str, action='store', help='audio folder path')
